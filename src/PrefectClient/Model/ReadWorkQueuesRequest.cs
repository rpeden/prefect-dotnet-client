...
{
    /// <summary>
    /// ReadWorkQueuesRequest
    /// </summary>
    [DataContract(Name = "ReadWorkQueuesRequest")]
    public partial class ReadWorkQueuesRequest : IEquatable<ReadWorkQueuesRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadWorkQueuesRequest {\n");
        ...
        {
            return this.Equals(input as ReadWorkQueuesRequest);
        }

        /// <summary>
        /// Returns true if ReadWorkQueuesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadWorkQueuesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadWorkQueuesRequest input)
        {
            if (input == null)
            {
                return false;
