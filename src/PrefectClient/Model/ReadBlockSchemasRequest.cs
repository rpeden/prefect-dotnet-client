...
{
    /// <summary>
    /// ReadBlockSchemasRequest
    /// </summary>
    [DataContract(Name = "ReadBlockSchemasRequest")]
    public partial class ReadBlockSchemasRequest : IEquatable<ReadBlockSchemasRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadBlockSchemasRequest {\n");
        ...
        {
            return this.Equals(input as ReadBlockSchemasRequest);
        }

        /// <summary>
        /// Returns true if ReadBlockSchemasRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadBlockSchemasRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadBlockSchemasRequest input)
        {
            if (input == null)
            {
                return false;
