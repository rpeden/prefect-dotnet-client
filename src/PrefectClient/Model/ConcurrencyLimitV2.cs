...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConcurrencyLimitV2")]
    public partial class ConcurrencyLimitV2 : IEquatable<ConcurrencyLimitV2>, IValidatableObject
    {
                /// <summary>
        /// Initializes a new instance of the <see cref="ConcurrencyLimitV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConcurrencyLimitV2() { }
        ...
        /// </summary>
        /// <value>The average amount of time a slot is occupied.</value>
        [DataMember(Name = "avg_slot_occupancy_seconds", EmitDefaultValue = false)]
        public decimal? AvgSlotOccupancySeconds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConcurrencyLimitV2 {\n");
            ...
            sb.Append("  AvgSlotOccupancySeconds: ").Append(AvgSlotOccupancySeconds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ConcurrencyLimitV2);
        }

        /// <summary>
        /// Returns true if ConcurrencyLimitV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ConcurrencyLimitV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConcurrencyLimitV2 input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AvgSlotOccupancySeconds == input.AvgSlotOccupancySeconds ||
                    this.AvgSlotOccupancySeconds.Equals(input.AvgSlotOccupancySeconds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AvgSlotOccupancySeconds.GetHashCode();
                return hashCode;
            }
        }
