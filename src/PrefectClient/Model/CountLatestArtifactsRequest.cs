...
{
    /// <summary>
    /// CountLatestArtifactsRequest
    /// </summary>
    [DataContract(Name = "CountLatestArtifactsRequest")]
    public partial class CountLatestArtifactsRequest : IEquatable<CountLatestArtifactsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountLatestArtifactsRequest {\n");
        ...
        {
            return this.Equals(input as CountLatestArtifactsRequest);
        }

        /// <summary>
        /// Returns true if CountLatestArtifactsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CountLatestArtifactsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountLatestArtifactsRequest input)
        {
            if (input == null)
            {
                return false;
