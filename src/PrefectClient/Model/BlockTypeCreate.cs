...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlockTypeCreate")]
    public partial class BlockTypeCreate : IEquatable<BlockTypeCreate>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockTypeCreate {\n");
        ...
        {
            return this.Equals(input as BlockTypeCreate);
        }

        /// <summary>
        /// Returns true if BlockTypeCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockTypeCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockTypeCreate input)
        {
            if (input == null)
            {
                return false;
