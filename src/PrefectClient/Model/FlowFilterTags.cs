...
namespace PrefectClient.Model
{
    ...
    /// Filter by `Flow.tags`.
    /// </summary>
    [DataContract(Name = "FlowFilterTags")]
    public partial class FlowFilterTags : IEquatable<FlowFilterTags>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of tags. Flows will be returned only if their tags are a superset of the list</value>
        ...
        /// </summary>
        /// <value>If true, only include flows without tags</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowFilterTags {\n");
        ...
        {
            return this.Equals(input as FlowFilterTags);
        }

        /// <summary>
        /// Returns true if FlowFilterTags instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowFilterTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowFilterTags input)
        {
            if (input == null)
            {
                return false;
