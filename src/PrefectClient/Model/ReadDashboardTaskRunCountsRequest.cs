...
{
    /// <summary>
    /// ReadDashboardTaskRunCountsRequest
    /// </summary>
    [DataContract(Name = "ReadDashboardTaskRunCountsRequest")]
    public partial class ReadDashboardTaskRunCountsRequest : IEquatable<ReadDashboardTaskRunCountsRequest>, IValidatableObject
    {
                /// <summary>
        /// Initializes a new instance of the <see cref="ReadDashboardTaskRunCountsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReadDashboardTaskRunCountsRequest() { }
        

        /// <summary>
        /// Gets or Sets TaskRuns
        /// </summary>
        [DataMember(Name = "task_runs", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadDashboardTaskRunCountsRequest {\n");
        ...
        {
            return this.Equals(input as ReadDashboardTaskRunCountsRequest);
        }

        /// <summary>
        /// Returns true if ReadDashboardTaskRunCountsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadDashboardTaskRunCountsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadDashboardTaskRunCountsRequest input)
        {
            if (input == null)
            {
                return false;
