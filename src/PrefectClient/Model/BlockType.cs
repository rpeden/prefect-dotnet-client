...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlockType")]
    public partial class BlockType : IEquatable<BlockType>, IValidatableObject
    {
                /// <summary>
        ...
        /// A block type's name
        /// </summary>
        /// <value>A block type&#39;s name</value>
        ...
        /// A block type's slug
        /// </summary>
        /// <value>A block type&#39;s slug</value>
        ...
        /// </summary>
        /// <value>Protected block types cannot be modified via API.</value>
        [DataMember(Name = "is_protected", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as BlockType);
        }

        /// <summary>
        /// Returns true if BlockType instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockType input)
        {
            if (input == null)
            {
                return false;
