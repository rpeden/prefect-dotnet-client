...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArtifactFilterType")]
    public partial class ArtifactFilterType : IEquatable<ArtifactFilterType>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArtifactFilterType {\n");
        ...
        {
            return this.Equals(input as ArtifactFilterType);
        }

        /// <summary>
        /// Returns true if ArtifactFilterType instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtifactFilterType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtifactFilterType input)
        {
            if (input == null)
            {
                return false;
