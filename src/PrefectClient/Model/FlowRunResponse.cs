...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlowRunResponse")]
    public partial class FlowRunResponse : IEquatable<FlowRunResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The id of the flow run&#39;s work pool.</value>
        ...
        /// </summary>
        /// <value>The name of the flow run&#39;s work pool.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowRunResponse {\n");
        ...
        {
            return this.Equals(input as FlowRunResponse);
        }

        /// <summary>
        /// Returns true if FlowRunResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowRunResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowRunResponse input)
        {
            if (input == null)
            {
                return false;
