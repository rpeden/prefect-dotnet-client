...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskRunFilterName")]
    public partial class TaskRunFilterName : IEquatable<TaskRunFilterName>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of task run names to include</value>
        /// <example>["my-task-run-1","my-task-run-2"]</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskRunFilterName {\n");
        ...
        {
            return this.Equals(input as TaskRunFilterName);
        }

        /// <summary>
        /// Returns true if TaskRunFilterName instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskRunFilterName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskRunFilterName input)
        {
            if (input == null)
            {
                return false;
