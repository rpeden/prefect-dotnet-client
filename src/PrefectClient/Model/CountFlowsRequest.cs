...
namespace PrefectClient.Model
{
    ...
    /// CountFlowsRequest
    /// </summary>
    [DataContract(Name = "CountFlowsRequest")]
    public partial class CountFlowsRequest : IEquatable<CountFlowsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountFlowsRequest {\n");
        ...
        {
            return this.Equals(input as CountFlowsRequest);
        }

        /// <summary>
        /// Returns true if CountFlowsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CountFlowsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountFlowsRequest input)
        {
            if (input == null)
            {
                return false;
