...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConcurrencyLimitV2Create")]
    public partial class ConcurrencyLimitV2Create : IEquatable<ConcurrencyLimitV2Create>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConcurrencyLimitV2Create {\n");
        ...
        {
            return this.Equals(input as ConcurrencyLimitV2Create);
        }

        /// <summary>
        /// Returns true if ConcurrencyLimitV2Create instances are equal
        /// </summary>
        /// <param name="input">Instance of ConcurrencyLimitV2Create to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConcurrencyLimitV2Create input)
        {
            if (input == null)
            {
                return false;
