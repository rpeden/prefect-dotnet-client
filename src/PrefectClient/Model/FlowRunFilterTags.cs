...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlowRunFilterTags")]
    public partial class FlowRunFilterTags : IEquatable<FlowRunFilterTags>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of tags. Flow runs will be returned only if their tags are a superset of the list</value>
        ...
        /// </summary>
        /// <value>If true, only include flow runs without tags</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowRunFilterTags {\n");
        ...
        {
            return this.Equals(input as FlowRunFilterTags);
        }

        /// <summary>
        /// Returns true if FlowRunFilterTags instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowRunFilterTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowRunFilterTags input)
        {
            if (input == null)
            {
                return false;
