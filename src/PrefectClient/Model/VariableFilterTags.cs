...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VariableFilterTags")]
    public partial class VariableFilterTags : IEquatable<VariableFilterTags>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of tags. Variables will be returned only if their tags are a superset of the list</value>
        ...
        /// </summary>
        /// <value>If true, only include Variables without tags</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VariableFilterTags {\n");
        ...
        {
            return this.Equals(input as VariableFilterTags);
        }

        /// <summary>
        /// Returns true if VariableFilterTags instances are equal
        /// </summary>
        /// <param name="input">Instance of VariableFilterTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariableFilterTags input)
        {
            if (input == null)
            {
                return false;
