...
{
    /// <summary>
    /// CountFlowRunsRequest
    /// </summary>
    [DataContract(Name = "CountFlowRunsRequest")]
    public partial class CountFlowRunsRequest : IEquatable<CountFlowRunsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountFlowRunsRequest {\n");
        ...
        {
            return this.Equals(input as CountFlowRunsRequest);
        }

        /// <summary>
        /// Returns true if CountFlowRunsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CountFlowRunsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountFlowRunsRequest input)
        {
            if (input == null)
            {
                return false;
