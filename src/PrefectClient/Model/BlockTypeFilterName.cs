...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlockTypeFilterName")]
    public partial class BlockTypeFilterName : IEquatable<BlockTypeFilterName>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockTypeFilterName {\n");
        ...
        {
            return this.Equals(input as BlockTypeFilterName);
        }

        /// <summary>
        /// Returns true if BlockTypeFilterName instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockTypeFilterName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockTypeFilterName input)
        {
            if (input == null)
            {
                return false;
