...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskRunFilterTags")]
    public partial class TaskRunFilterTags : IEquatable<TaskRunFilterTags>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of tags. Task runs will be returned only if their tags are a superset of the list</value>
        ...
        /// </summary>
        /// <value>If true, only include task runs without tags</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskRunFilterTags {\n");
        ...
        {
            return this.Equals(input as TaskRunFilterTags);
        }

        /// <summary>
        /// Returns true if TaskRunFilterTags instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskRunFilterTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskRunFilterTags input)
        {
            if (input == null)
            {
                return false;
