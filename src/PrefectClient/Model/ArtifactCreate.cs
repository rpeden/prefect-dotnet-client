...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArtifactCreate")]
    public partial class ArtifactCreate : IEquatable<ArtifactCreate>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArtifactCreate {\n");
        ...
        {
            return this.Equals(input as ArtifactCreate);
        }

        /// <summary>
        /// Returns true if ArtifactCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtifactCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtifactCreate input)
        {
            if (input == null)
            {
                return false;
