...
namespace PrefectClient.Model
{
    ...
    /// ReadFlowsRequest
    /// </summary>
    [DataContract(Name = "ReadFlowsRequest")]
    public partial class ReadFlowsRequest : IEquatable<ReadFlowsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadFlowsRequest {\n");
        ...
        {
            return this.Equals(input as ReadFlowsRequest);
        }

        /// <summary>
        /// Returns true if ReadFlowsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadFlowsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadFlowsRequest input)
        {
            if (input == null)
            {
                return false;
