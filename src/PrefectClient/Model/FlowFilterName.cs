...
namespace PrefectClient.Model
{
    ...
    /// Filter by `Flow.name`.
    /// </summary>
    [DataContract(Name = "FlowFilterName")]
    public partial class FlowFilterName : IEquatable<FlowFilterName>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of flow names to include</value>
        /// <example>["my-flow-1","my-flow-2"]</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowFilterName {\n");
        ...
        {
            return this.Equals(input as FlowFilterName);
        }

        /// <summary>
        /// Returns true if FlowFilterName instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowFilterName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowFilterName input)
        {
            if (input == null)
            {
                return false;
