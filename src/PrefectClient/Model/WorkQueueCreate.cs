...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkQueueCreate")]
    public partial class WorkQueueCreate : IEquatable<WorkQueueCreate>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkQueueCreate {\n");
        ...
        {
            return this.Equals(input as WorkQueueCreate);
        }

        /// <summary>
        /// Returns true if WorkQueueCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkQueueCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkQueueCreate input)
        {
            if (input == null)
            {
                return false;
