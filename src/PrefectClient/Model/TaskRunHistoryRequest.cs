...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskRunHistoryRequest")]
    public partial class TaskRunHistoryRequest : IEquatable<TaskRunHistoryRequest>, IValidatableObject
    {
                /// <summary>
        /// Initializes a new instance of the <see cref="TaskRunHistoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskRunHistoryRequest() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskRunHistoryRequest {\n");
        ...
        {
            return this.Equals(input as TaskRunHistoryRequest);
        }

        /// <summary>
        /// Returns true if TaskRunHistoryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskRunHistoryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskRunHistoryRequest input)
        {
            if (input == null)
            {
                return false;
