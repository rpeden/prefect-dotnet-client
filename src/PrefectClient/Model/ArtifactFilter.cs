...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArtifactFilter")]
    public partial class ArtifactFilter : IEquatable<ArtifactFilter>, IValidatableObject
    {
        ...
        public ArtifactFilterId Id { get; set; }

        /// <summary>
        /// Gets or Sets Key
        /// </summary>
        [DataMember(Name = "key", EmitDefaultValue = false)]
        public ArtifactFilterKey Key { get; set; }

        /// <summary>
        /// Gets or Sets FlowRunId
        /// </summary>
        [DataMember(Name = "flow_run_id", EmitDefaultValue = false)]
        public ArtifactFilterFlowRunId FlowRunId { get; set; }

        /// <summary>
        /// Gets or Sets TaskRunId
        /// </summary>
        [DataMember(Name = "task_run_id", EmitDefaultValue = false)]
        public ArtifactFilterTaskRunId TaskRunId { get; set; }

        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        [DataMember(Name = "type", EmitDefaultValue = false)]
        public ArtifactFilterType Type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArtifactFilter {\n");
        ...
        {
            return this.Equals(input as ArtifactFilter);
        }

        /// <summary>
        /// Returns true if ArtifactFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtifactFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtifactFilter input)
        {
            if (input == null)
            {
                return false;
