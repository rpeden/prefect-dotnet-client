...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlowRunNotificationPolicyUpdate")]
    public partial class FlowRunNotificationPolicyUpdate : IEquatable<FlowRunNotificationPolicyUpdate>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowRunNotificationPolicyUpdate {\n");
        ...
        {
            return this.Equals(input as FlowRunNotificationPolicyUpdate);
        }

        /// <summary>
        /// Returns true if FlowRunNotificationPolicyUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowRunNotificationPolicyUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowRunNotificationPolicyUpdate input)
        {
            if (input == null)
            {
                return false;
