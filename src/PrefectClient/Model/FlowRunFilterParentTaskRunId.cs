...
namespace PrefectClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlowRunFilterParentTaskRunId")]
    public partial class FlowRunFilterParentTaskRunId : IEquatable<FlowRunFilterParentTaskRunId>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A list of flow run parent_task_run_ids to include</value>
        ...
        /// </summary>
        /// <value>If true, only include flow runs without parent_task_run_id</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowRunFilterParentTaskRunId {\n");
        ...
        {
            return this.Equals(input as FlowRunFilterParentTaskRunId);
        }

        /// <summary>
        /// Returns true if FlowRunFilterParentTaskRunId instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowRunFilterParentTaskRunId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowRunFilterParentTaskRunId input)
        {
            if (input == null)
            {
                return false;
